...
var memory_flash : array[$00000000..$0000FFFF] of byte;
    memory_ram   : array[$20000000..$20004FFF] of byte;
...
begin
  ...
  case addr of
    ...
    $40013800: read32 := $FFFFFFFF; // UART never busy
...
begin
  ...
  for memaddr := 0 to 64*256-1 do store32(memaddr * 4, $e339e339); // Special initialisation for flash memory in this chip.
  for memaddr := 0 to 20*256-1 do store32(memaddr * 4, $00000000);
  ...
  // for i := 1 to 100000 do // Maximum amount of instructions...
  // begin
  repeat
