...
# -----------------------------------------------------------------------------
    ...
    .equ _RCC_APB2Periph_USART1,           (0x00004000)
...
# HSION is on ..
# R32_RCC_APB2PCENR = RCC_APB2Periph_USART1 | RCC_APB2Periph_GPIOA
# R32_GPIOA_CFGHR =
# pa9 == Tx, pa10 = Rx
# MODE10 = 3, MODE9=3
# CNF10 = 2, CNF9 = 2
# power on uart and pa
  ...
  li  x14, 0x4004  #_RCC_APB2Periph_USART1 + _RCC_APB2Periph_GPIOA
  sw  x14, 0(x15)
# pa9/10 init
  lui x14, (3<<9)
